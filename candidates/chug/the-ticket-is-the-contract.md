...
description: "Write the ticket as the contract both the implementer and the reviewer are held to."
status: draft
tags:
  - bucket/chug
  - scope/process
...
- [Acceptance criteria name an observation, not an intention](../general/process/acceptance-criteria-are-checkable.md)

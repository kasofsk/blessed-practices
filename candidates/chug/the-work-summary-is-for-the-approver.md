...
description: "Write the work summary for the person or agent who must approve it."
status: draft
tags:
  - bucket/chug
  - scope/process
...
- [The commit message carries the why](../general/documentation/commit-messages-carry-the-why.md)
